...
const ALL_MENU_ITEMS = [
  ...
  { href: '/purchase-requests', label: 'Purchase Requests', icon: ClipboardList, group: 'Operations', permission: P.PURCHASE_VIEW },
  ...
  { href: '/outbound',    label: 'Outbound',    icon: ArrowUpRight,    group: 'Operations',  permission: P.ORDERS_VIEW     },
  { href: '/returns',     label: 'Returns / RMA', icon: RotateCcw,       group: 'Operations',  permission: P.INVENTORY_VIEW  },
  ...
  { href: '/master/suppliers',  label: 'Suppliers',        icon: Users,     group: 'Admin', permission: P.MASTER_VIEW },
  { href: '/master/allotments', label: 'Rack Allotments',  icon: Warehouse, group: 'Admin', permission: P.MASTER_VIEW },
...
const NavItem = memo(function NavItem({ item, isCollapsed, liveValue, isFavorite, onToggleFavorite }) {
...
const SectionHeader = memo(function SectionHeader({ label, icon: Icon, isExpanded, onToggle, isCollapsed, itemCount, stats }) {
          ...
          <div className="flex min-w-0 items-center gap-2.5">
            ...
            {!isCollapsed && (
              <div className="min-w-0 max-w-[11rem]">
                <p className="truncate text-[0.92rem] font-semibold leading-none text-sidebar-foreground">WMS Pro Control Tower</p>
                <p className="mt-0.5 truncate text-[11px] text-sidebar-foreground/55">Fast routing, live queues, shared tables</p>
              </div>
            )}
          </div>
        </div>
        ...
        <div className={cn(
          ...
          {!isCollapsed && (
            <div className="min-w-0 flex-1">
              <p className="truncate text-[0.72rem] font-semibold text-sidebar-foreground">{displayName}</p>
              <p className="truncate text-[0.6rem] text-sidebar-foreground/40 mt-0.5">{displayRole}</p>
            </div>
          )}
          {!isCollapsed && (
            <Tooltip>
