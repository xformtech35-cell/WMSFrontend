...
import GoodsReceivingModal from "./component/GoodsReceivingModal";
...
export default function InboundPage() {
  ...
  const handleReceivingClick = (inbound) => {
    setReceivingInbound(inbound);
    setShowReceivingModal(true);
  };

  const handleReceivingSuccess = (receivingData) => {
    setSuccessMessage(
      `Goods received successfully for ${receivingInbound?.inboundNumber}!`,
    );
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 py-6 max-w-7xl">
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center justify-center gap-1.5">
                          ...
                          {inbound.stage === "UNLOADING" && (
                            <button
                              type="button"
                              onClick={() => handleReceivingClick(inbound)}
        ...
        {showReceivingModal && receivingInbound && (
          <GoodsReceivingModal
            isOpen={showReceivingModal}
            onClose={() => {
              setShowReceivingModal(false);
              setReceivingInbound(null);
            }}
