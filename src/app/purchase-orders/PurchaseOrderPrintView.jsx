          ...
          <div style={{ textAlign: "right", minWidth: "200px" }}>
            ...
            <div style={{ marginTop: "5px", fontSize: "11px" }}>
              <div>
                ...
                <span style={{ color: "#2563EB" }}>{po.poNumber}</span>
              </div>
              <div>
        ...
        >
          <div>
            ...
            <div style={{ fontSize: "10.5px" }}>
              ...
              {po.supplierAddress && (
                <div style={{ color: "#4B5563" }}>{po.supplierAddress}</div>
              )}
              {po.supplierEmail && (
              ...
              {po.supplierPhone && (
                <div style={{ color: "#4B5563" }}>
                  <strong>Phone:</strong> {po.supplierPhone}
                </div>
              )}
            </div>
          </div>
          ...
          >
            ...
            <tbody>
              {po.lines?.map((line, index) => (
                <tr key={line.id || index}>
                  ...
                  <td
                    style={{ border: "1px solid #D1D5DB", padding: "5px 8px" }}
                  >
                    {line.itemCode || "-"}
                  </td>
                  <td
            ...
            <tfoot>
              <tr>
                ...
                <td style={{ border: "1px solid #D1D5DB", textAlign: "right" }}>
