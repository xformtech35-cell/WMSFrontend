...
const ShippingLabelModal = ({
  ...
  const labelData = {
    ...
    soNumber: shippingLabel.soNumber || "",
    packageNumber: shippingLabel.packageNumber || "",
    packageBarcode: shippingLabel.packageBarcode || "",
    customer: shippingLabel.customerName || "",
    item: shippingLabel.itemName || "",
    quantity: shippingLabel.quantity || "",
    weight: shippingLabel.weight ? `${shippingLabel.weight} KG` : "",
    shippingAddress: "Same as Ship To",
    shippingMethod: shippingLabel.shippingMethod || "",
  ...
  const createFallbackImage = () => {
    return new Promise((resolve) => {
      ...
      let yRight = 150;
      ctx.fillText(
        "PACKAGE NO. : " + labelData.packageNumber,
        width - 30,
        yRight,
      );
      yRight += 22;
      ...
      yRight += 22;
      ctx.fillText(
        "SHIPPING DATE : " + labelData.shippingDate,
        width - 30,
        yRight,
      );
      yRight += 35;
