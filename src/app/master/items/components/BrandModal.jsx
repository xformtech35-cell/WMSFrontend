...
export default function BrandModal({ isOpen = false, onClose, onBrandChange }) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      ...
      setErrorMessage(
        error.message || `Failed to ${isEditing ? "update" : "create"} brand.`
      );
    } finally {
      setSaving(false);
    }
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">
                  Add and edit product item brands
                </p>
              </div>
            </div>
            <button
          ...
          <div className="p-6 space-y-6">
            ...
            <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
              <h3 className="text-sm font-semibold text-gray-800 mb-3 flex items-center gap-2">
                {isEditing ? (
                  <>
                    <Edit className="w-4 h-4 text-green-600" /> Edit Brand
                  </>
                ) : (
                  <>
                    <Plus className="w-4 h-4 text-indigo-600" /> Add New Brand
                  </>
                )}
              </h3>
              <form onSubmit={handleFormSubmit} className="space-y-3">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  ...
                  <div>
                    ...
                    <input
                      type="text"
                      placeholder="Electronics manufacturer..."
                ...
                <div className="flex items-center justify-between pt-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      type="submit"
                      disabled={saving}
                      className="px-4 py-1.5 text-xs font-medium text-white bg-indigo-600 rounded-lg hover:bg-indigo-700 transition-colors flex items-center gap-1 disabled:opacity-50"
                    >
                      {saving ? (
                        <>
            ...
            <div className="flex items-center justify-between gap-3 flex-wrap">
              <div className="relative flex-1 min-w-[200px]">
                ...
                <input
                  ...
                  className="pl-9 pr-3 py-1.5 w-full text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                />
              </div>
              <button
                type="button"
              ...
              <table className="w-full text-sm text-left text-gray-600">
                ...
                <tbody className="divide-y divide-gray-200">
                  {loading ? (
                    ...
                    brands.map((brand) => (
                      <tr key={brand.id || brand.code} className="hover:bg-gray-50">
